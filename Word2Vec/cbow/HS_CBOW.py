...
def HS_cbow(input_file_name,output_file_name1,output_file_name2,embed_size,window_size,embed_epoch, init_lr,decay,indi_context):
    """
    ...
    u_embed_mat,w_embed_mat = train_cbow(train_set, embed_epoch, init_lr, len(word2id), embed_size,decay=DECAY)  ##模型训练
...
if __name__ == '__main__':
    u_embed_mat,w_embed_mat = HS_cbow(input_file_name, output_file_name1,output_file_name2, embed_size, window_size, embed_epoch, init_lr, DECAY,indi_context)