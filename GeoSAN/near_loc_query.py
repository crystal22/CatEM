...
if __name__ == "__main__":
    ...
    # filename_clean = os.path.join(args.dataset, "LSBNDataset_NYC.data")
    # save_path = os.path.join(args.dataset, "loc_query_tree.pkl")

    filename_raw = ".\\data\\dataset_TSMC2014_NYC_for_GeoSAN.txt"
    filename_clean = ".\\data\\LSBNDataset.data"
    save_path = ".\\data\\loc_query_tree.pkl"
